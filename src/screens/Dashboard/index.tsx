...
export function Dashboard() {
  ...
  async function loadTransactions(){
    ...
    const totalInterval = lastTransactionExpensives === '0' ? 'Não há transação' : `01 a ${lastTransactionExpensives}`;
    ...
    setHighlightData({
        ...
        expensives: {
            ...
            lastTransaction:  lastTransactionExpensives === '0' ? 'Não há transação' : `Última saída dia ${lastTransactionExpensives}`,
        },
        total: {
